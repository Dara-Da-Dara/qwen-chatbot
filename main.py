"""
Qwen3 Chatbot — FastAPI backend (flat layout: everything at repo root).

Backends, chosen with the CHAT_BACKEND env var:
...
Env vars:
  ...
  MODEL_NAME       HF repo id or API name (default: Qwen/Qwen3-0.6B)
  ENABLE_THINKING  1 | 0                  (default: 0)
  # only for CHAT_BACKEND=api:
...
# Serve the single-file frontend (index.html sits next to this file).
@app.get("/")
